...
//Start custom added
int resultsEntryIndex = -1;
if(request.getAttribute("view_entry_content.jsp-resultsEntryIndex") != null) {
	resultsEntryIndex = (Integer)request.getAttribute("view_entry_content.jsp-resultsEntryIndex");	
}
String entryCssClass = "";
if(resultsEntryIndex == -1 || resultsEntryIndex%2 == 0) {
	entryCssClass = "";
} else {
	entryCssClass = "entry-odd";
}
//End custom added
%>
